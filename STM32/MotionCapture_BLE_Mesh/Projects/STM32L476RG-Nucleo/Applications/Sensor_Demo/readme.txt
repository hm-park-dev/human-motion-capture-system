/**
  @page The FP-SNS-BLEMESH1 Application firmware package is an Embedded software to be used with ST BlueNRG Devices to show Sensor Model of BLE MESH Capabilities
...
@par Hardware and Software environment
  ...
  - This example runs on Sensor expansion board (IKS01A3) attached to BlueNRG-MS and STM32L476RG devices.
  ...
  - This example has been tested with STMicroelectronics NUCLEO-L476RE RevC and
...
For STM32CubeIDE:
 ...
 - Open the STM32CubeIDE project file STM32CubeIDE\Sensor-STM32_BNRG2A1\.cproject  for X-NUCLEO-BlueNRG2A1 and STM32CubeIDE\Sensor-STM32_BNRGMS for X-NUCLE0-IDB05A1/A2
 - Rebuild all files and load your image into target memory.
 - Run the example.
