...
---------------------------
1. STM32L4_BNRG_MS_Sensor_Model : This binary uses static random address of the controller to generate MAC address for X-NUCLEO-IDB05A1/A2.
2. STM32L4_BNRG2A1_Sensor_Model : This binary uses static random address of the controller to generate MAC address for X-NUCLEO-BNRG2A1.                           
