...
/* Private variables ---------------------------------------------------------*/
MOBLEUINT8 NetKey[16];
MOBLEUINT8 AppKey[16];
MOBLEUINT8 DevKey[16];
...
{
  /* TRACE_I(TF_CONFIG_SERVER,"AppKey binding received for elementIndex %d, modelID %.2x,\
...
{
  /* TRACE_I(TF_CONFIG_SERVER,"AppKey unbinding received for elementIndex %d, modelID %.2x,\
...
void Appli_GetSubAddParamsCb(model_subParams_t* subAddParams)
{
  ...
  {
   /* TRACE_I(TF_CONFIG_SERVER,"Subscription Virtual Add received for elementIndex %d, modelID %.2x & subAddress %.2x \r\n",\
  ...
  {
   /* TRACE_I(TF_CONFIG_SERVER,"Subscription Add received for elementIndex %d, modelID %.2x & subAddress %.2x \r\n",\
                              subAddParams->elementIndex, subAddParams->modelID,\
                                                 subAddParams->subAddress); */
  }
}
...
void Appli_GetSubDeleteParamsCb(model_subParams_t* subDeleteParams)
{
  ...
  {
   /* TRACE_I(TF_CONFIG_SERVER,"Subscription Virtual Add Delete received for elementIndex %d, modelID %.2x & subAddress %.2x \r\n",\
  ...
  else if(subDeleteParams->allSubDeleted)
  {
   ...
   /*  TRACE_I(TF_CONFIG_SERVER,"Delete All Subscription received for elementIndex %d, modelID %.2x \r\n",\
                              subDeleteParams->elementIndex, subDeleteParams->modelID);    */    
    
  }
  else
  {
  /*  TRACE_I(TF_CONFIG_SERVER,"Subscription Delete received for elementIndex %d, modelID %.2x & subAddress %.2x \r\n",\
                              subDeleteParams->elementIndex, subDeleteParams->modelID,\
                                                 subDeleteParams->subAddress); */
  }  
}
...
void Appli_GetSubOverwriteParamsCb(model_subParams_t* subOverwriteParams)
{
  ...
  {
  /*  TRACE_I(TF_CONFIG_SERVER,"Subscription Virtual Overwrite received for elementIndex %d, modelID %.2x & subAddress %.2x \r\n",\
  ...
  {
   /* TRACE_I(TF_CONFIG_SERVER,"Subscription Overwrite received for elementIndex %d, modelID %.2x & subAddress %.2x \r\n",\
                     subOverwriteParams->elementIndex, subOverwriteParams->modelID,\
                                                 subOverwriteParams->subAddress); */
  }  
}
...
void Appli_GetPublicationGetParamsCb(model_publicationparams_t* pPubParameters)
{
 /* TRACE_I(TF_CONFIG_SERVER,"Status is : %.2x \r\n", pPubParameters->status); 
  TRACE_I(TF_CONFIG_SERVER,"Received Publication parameters:  credentialFlag = %.2x,\
          elementAddress = %.2x, modelID = %.2x, appKeyIndex = %.2x,\
