...
#define ENABLE_SENSOR_MODEL_SERVER_SETUP              ENABLE_SENSOR_MODEL_SERVER
  ...
  #define ENABLE_LIGHT_MODEL_SERVER_LC_SETUP          ENABLE_LIGHT_MODEL_SERVER_LC
    ...
    #error "Number of elements should be >= 2 with Light LC Server"
      ...
      #error "Light Lightness Server should be supported with Light LC Server (on different element)"
    #endif
  #else
    #error "Light Lightness Server should be supported with Light LC Server (on different element)"
#endif
...
#elif defined(ENABLE_LIGHT_MODEL_SERVER_HSL) || defined(ENABLE_LIGHT_MODEL_SERVER_HSL_SETUP) \
...
*/
#define SIZE_OF_SENSOR_PARAMS_T                                               56
/**
