...
/* Provisioner feature related configuration */
  ...
  */
  ...
  #define CLIENT_MAX_SIG_MODELS_PER_ELEMENT    10 /* Number of SIG Models for Node under provisioning */   
  #define CLIENT_MAX_VENDOR_MODELS_PER_ELEMENT 1  /* Number of Vendor Models for Node under provisioning */ 
  #define CLIENT_MAX_ELEMENTS_PER_NODE         3  /* Number of Elements per Node */
...
#define TF_GENERIC                         1 //0
#define TF_GENERIC_CLIENT                  1 //0
#define TF_SENSOR                          0
#define TF_LIGHT                           0
...
/* Disabled by default */
#define TF_COMMON                          0
#define TF_GENERIC_M                       1 //0
#define TF_GENERIC_CLIENT_M                1 //0
...
#define TF_MEMORY                          0
#define TF_BEACON                          0
#define TF_SERIAL_CTRL                     0  /* Opcode printing on Serial port */
#define TF_VENDOR_APPLI_TEST               0  /* Vendor commands testing */
#define TF_NVM                             0
#define TF_SCRIPT_GENERIC                  0   //enable for running the script
#define TF_SCRIPT_LIGHT                   0
/*******************************************************************************
...
//#define ENABLE_LIGHT_MODEL_SERVER_CTL                                      (3)
//#define ENABLE_LIGHT_MODEL_SERVER_CTL_SETUP                                (3)
//#define ENABLE_LIGHT_MODEL_SERVER_CTL_TEMPERATURE                          (3)
//#define ENABLE_LIGHT_MODEL_SERVER_HSL                                      (3)
//#define ENABLE_LIGHT_MODEL_SERVER_HSL_SETUP                                (3)
//#define ENABLE_LIGHT_MODEL_SERVER_HSL_HUE                                  (3)
//#define ENABLE_LIGHT_MODEL_SERVER_HSL_SATURATION                           (3)

/* 
   The following models is managed in different file light_lc.c in middleware
   It also enables Light LC Setup Server on corresponding elements
   Atleast 2 elements are required for LC Server
     If supported on more than 1 element, first element index with LC Server is used
     LC server should be accompanied by Generic OnOff Server and 
       Generic Power OnOff Server on same element and Light Lightness Server on 
       different element
  LC server on element index 0 not recognized by PTS v7.6.1 (use on element index 1)
*/
...
#define GENERIC_SERVER_MODEL_PUBLISH                                         (1)                                                           

/* Define the following Macros to enable the usage of the Client Generic Models  */
#define ENABLE_GENERIC_MODEL_CLIENT_ONOFF                                    (3)
...
//#define ENABLE_LIGHT_MODEL_CLIENT_HSL 
...
@ Uncomment the corresponding  client model macro for publishing with this macro
@ For GENERIC_CLIENT_MODEL_PUBLISH, 
  Uncomment ENABLE_GENERIC_MODEL_CLIENT_ONOFF ,ENABLE_GENERIC_MODEL_CLIENT_LEVEL 
@ For LIGHT_CLIENT_MODEL_PUBLISH
  Uncomment ENABLE_LIGHT_MODEL_CLIENT_LIGHTNESS
*/

#define GENERIC_CLIENT_MODEL_PUBLISH  
//#define LIGHT_CLIENT_MODEL_PUBLISH

/* Macros defined for the publishing with server models */
//#define VENDOR_SERVER_MODEL_PUBLISH
/******************************************************************************/
...
/*Maximum Models supported per element is already defined, Please don't increase it*/ 
#define USER_SIG_MODELS_MAX_COUNT            9
...
*if board has RGB leds as well as cool warm leds, uncomment USER_BOARD_COOL_WHITE_LED
  and USER_BOARD_RGB_LED and CUSTOM_BOARD_PWM_SELECTION
*/
