...
#define ADDR_FLASH_PAGE_256   ((uint32_t)0x08100000) /* Base @ of Page 256, 2 Kbytes */
#define ADDR_FLASH_PAGE_258   ((uint32_t)0x08101000) /* Base @ of Page 258, 2 Kbytes */
#else
...
#ifdef STM32_SENSORTILEBOX // STM32L4R9ZI: page size = 4KB
    erase.Page        = 1; //0x0810 1000: BLE MESH NVM CONF DATA (BDADDRESS is stored at 0x08100000)
    erase.NbPages     = 1;
#else //STM32L476RG: page size = 2KB
    erase.Page        = 2; //0x0808 1000: BLE MESH NVM CONF DATA (BDADDRESS is stored at 0x08080000 )
    erase.NbPages     = 2;
#endif
