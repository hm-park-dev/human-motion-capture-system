...
#define _LLIO_ERROR ((size_t)-1) /* For __read and __write. */
  ...
  #include "STBOX1_config.h" //SB Code
  #include "bluenrg1_hci_le.h" //SB Code
#endif
...
{
  return HAL_GPIO_ReadPin(USER_BUTTON_GPIO_PORT, USER_BUTTON_PIN); /*return HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13);*/
}
...
#elif defined(STM32L4) || defined(STM32L4R9xx) 
  init.Speed = GPIO_SPEED_LOW;  
