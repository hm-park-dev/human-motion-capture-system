...
*/
#define TOTAL_SENSORS_COUNT                                                 3 //6

/**
* Sum of sensor settings on all sensors on all elements
* Sensor init fails in case of mismatch with sensor server initialization parameters
*/
#define TOTAL_SENSOR_SETTINGS_COUNT                                         12
...
#define SENSOR2_PROPERTY_ID                    PRESSURE_CUSTOM_PID
...
#define SENSOR3_PROPERTY_ID                    HUMIDITY_PID
...
#define SENSOR4_PROPERTY_ID                    MAGNETO_METER_PID
...
#define SENSOR5_PROPERTY_ID                    ACCELERO_METER_PID
...
/* Sensor 6 initialization */
#define SENSOR6_ELEMENT_IDX                    0
#define SENSOR6_PROPERTY_ID                    GYROSCOPE_PID
...
#define SENSOR6_DATA_LENGTH                    12
#define SENSOR6_CADENCE_STATE                  SENSOR_CADENCE_SUPPORTED
#define SENSOR6_VALUES_RANGE                   200
#define SENSOR6_SETTINGS_COUNT                 1
#define SENSOR6_SETTING1_PROPERTY_ID           0xAAAA
#define SENSOR6_SETTING1_ACCESS                SENSOR_SETTING_ACCESS_READ_WRITE
#define SENSOR6_SETTING1_RAW                   35666
#define SENSOR6_SERIES_COUNT                   0

#define SENSOR6_SETTINGS_INIT_PARAMS \
{\
  SENSOR6_SETTING1_PROPERTY_ID,\
  SENSOR6_SETTING1_ACCESS,\
  SENSOR6_SETTING1_RAW\
}
