---
pagetitle: Release Notes for MotionGR Library
lang: en
...
<center>
# Release Notes for MotionGR Gesture Recognition Library
...
- The MotionGR provides real-time information about the gesture which the user just performed with the device, i.e. cell phone.
- The library acquires data from the accelerometer and provides information about the gesture which the user just performed with the device. It is able to distinguish following gestures: pick up, glance, wake up.
...
- [Getting started with MotionGR real-time gesture recognition library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00385841-getting-started-with-motiongr-realtime-gesture-recognition-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section12" aria-hidden="true">V2.2.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section11" aria-hidden="true">V2.2.0 / 10-May-2021</label>
<div>			
...
<label for="collapse-section9" aria-hidden="true">V2.1.1 / 19-June-2020</label>
<div>			
...
<label for="collapse-section8" aria-hidden="true">V2.1.0 / 10-February-2020</label>
<div>			
...
<label for="collapse-section1" aria-hidden="true">V1.0.0 / 29-January-2016</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionGR** ,
