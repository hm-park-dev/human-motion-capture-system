---
pagetitle: Release Notes for MotionSD Library
lang: en
...
<center>
# Release Notes for MotionSD Standing vs Sitting Desk Detection Library
...
- The MotionSD provides real-time information about the user working mode: sitting at the desk or standing desk position.
- The library acquires data from the accelerometer and pressure sensor and provides information about the user working mode.
...
- [Getting started with MotionSD standing vs sitting desk detection library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00427992-getting-started-with-motionsd-standing-vs-sitting-desk-detection-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section5" aria-hidden="true">V1.2.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section4" aria-hidden="true">V1.2.0 / 13-May-2021</label>
<div>			
...
<label for="collapse-section3" aria-hidden="true">V1.1.0 / 13-November-2020</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionSD** ,
