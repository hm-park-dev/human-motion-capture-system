---
pagetitle: Release Notes for MotionVC Library
lang: en
...
<center>
# Release Notes for MotionVC Vertical Context Library
...
- The MotionVC provides real-time information about change of altitude and is able to distinguish type of vertical movement: stairs, elevator, and escalator.
- The library acquires data from the accelerometer and pressure sensor and provides information about the vertical context.
...
- [Getting started with MotionVC vertical context library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00542666-getting-started-with-motionvc-vertical-context-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section6" aria-hidden="true">V1.2.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section5" aria-hidden="true">V1.2.0 / 14-May-2021</label>
<div>			
...
<label for="collapse-section4" aria-hidden="true">V1.1.1 / 19-June-2020</label>
<div>			
...
<label for="collapse-section3" aria-hidden="true">V1.1.0 / 10-February-2020</label>
<div>			
...
<label for="collapse-section1" aria-hidden="true">V1.0.0 / 15-September-2018</label>
<div>			
...
- System Workbench for STM32 V2.5.0
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionVC** ,
