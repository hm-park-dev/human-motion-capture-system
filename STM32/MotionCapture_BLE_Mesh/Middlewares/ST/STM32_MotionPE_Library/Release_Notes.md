---
pagetitle: Release Notes for MotionPE Library
lang: en
...
<center>
# Release Notes for MotionPE Pose Estimation Library
...
- The MotionPE provides real-time information about the user current pose.
- The library acquires data from the accelerometer and provides information about the user current pose based on data from a device. It is able to distinguish following poses: sitting, standing, lying down. The library is intended for wrist based device.
...
- [Getting started with MotionPE real-time pose estimation library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00395951-getting-started-with-motionpe-realtime-pose-estimation-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section11" aria-hidden="true">V2.2.0 / 11-May-2021</label>
<div>			
...
<label for="collapse-section10" aria-hidden="true">V2.1.0 / 13-November-2020</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionPE** ,
