---
pagetitle: Release Notes for MotionAT Library
lang: en
...
<center>
# Release Notes for MotionAT Active Time Library
...
- The MotionAT provides real-time information about the number of active seconds which the user performed with the wearable device, e.g. smart watch.
- The library acquires data from the accelerometer and provides information about the number of active seconds which the user performed with the device.
...
- [Getting started with MotionAT active time library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00472436-getting-started-with-motionat-active-time-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section12" aria-hidden="true">V1.2.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section11" aria-hidden="true">V1.2.0 / 28-April-2021</label>
<div>			
...
<label for="collapse-section10" aria-hidden="true">V1.1.0 / 13-November-2020</label>
<div>			
...
<label for="collapse-section9" aria-hidden="true">V1.0.1 / 15-February-2019</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionAT** ,
