---
pagetitle: Release Notes for MotionGC Library
lang: en
...
<center>
# Release Notes for MotionGC Gyroscope Calibration Library
...
- The MotionGC provides real-time gyroscope calibration through angular zero-rate level coefficients (offset) used to correct gyroscope data.
- The library acquires data from the accelerometer and gyroscope and counts the angular zero-rate level coefficient (offset) for each axis. The angular zero-rate level coefficients are subsequently used to compensate raw data coming from gyroscope.
...
- [Getting started with MotionGC gyroscope calibration library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00372763-getting-started-with-motiongc-gyroscope-calibration-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section11" aria-hidden="true">V2.5.0 / 10-May-2021</label>
<div>			
...
<label for="collapse-section10" aria-hidden="true">V2.4.0 / 26-February-2021</label>
<div>			
...
<label for="collapse-section1" aria-hidden="true">V1.0.0 / 01-December-2016</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionGC** ,
