---
pagetitle: Release Notes for MotionPM Library
lang: en
...
<center>
# Release Notes for MotionPM Pedometer Library
...
- The MotionPM provides real-time information about the number of steps and cadence which the user just performed with the device, i.e. cell phone.
- The library acquires data from the accelerometer and provides information about the number of steps and cadence which the user just performed with the device.
...
- [Getting started with MotionPM real-time pedometer library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00388230-getting-started-with-motionpm-realtime-pedometer-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section11" aria-hidden="true">V2.4.0 / 12-May-2021</label>
<div>			
...
<label for="collapse-section10" aria-hidden="true">V2.3.0 / 13-November-2020</label>
<div>			
...
<label for="collapse-section8" aria-hidden="true">V2.2.0 / 02-October-2019</label>
<div>			
...
- Library optimization to reduce the computation cost
...
<label for="collapse-section4" aria-hidden="true">V2.1.0 / 28-September-2018</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionPM** ,
