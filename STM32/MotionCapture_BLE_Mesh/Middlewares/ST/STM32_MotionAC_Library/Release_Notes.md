---
pagetitle: Release Notes for MotionAC Library
lang: en
...
<center>
# Release Notes for MotionAC Accelerometer Calibration Library
...
- The MotionAC provides real-time accelerometer calibration.
- The library acquires data from the accelerometer and counts the offset and scale factor coefficients together with the calibration quality value. The offset and scale factor coefficients are then used to compensate raw data coming from accelerometer.
...
- [Getting started with MotionAC accelerometer calibration library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00373531-getting-started-with-motionac-accelerometer-calibration-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section12" aria-hidden="true">V2.6.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section11" aria-hidden="true">V2.6.0 / 21-April-2021</label>
<div>			
...
<label for="collapse-section10" aria-hidden="true">V2.5.0 / 16-December-2020</label>
<div>			
...
<label for="collapse-section9" aria-hidden="true">V2.4.1 / 29-May-2020</label>
<div>			
...
- System Workbench for STM32 V2.7.0.201811131241
...
<label for="collapse-section7" aria-hidden="true">V2.3.0 / 11-June-2019</label>
<div>			
...
- System Workbench for STM32 V2.6.0.201809060829
...
<label for="collapse-section5" aria-hidden="true">V2.2.0 / 28-September-2018</label>
<div>			
...
- Improved initial response of the algorithm
...
- System Workbench for STM32 V2.4.0.201801120948
...
<label for="collapse-section4" aria-hidden="true">V2.1.0 / 01-November-2017</label>
<div>			
...
- System Workbench for STM32 V1.13.1.20170120
...
- System Workbench for STM32 V1.10.0.20160725
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionAC** ,
