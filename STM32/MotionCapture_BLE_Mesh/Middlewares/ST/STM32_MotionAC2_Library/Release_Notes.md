---
pagetitle: Release Notes for MotionAC2 Library
lang: en
...
<center>
# Release Notes for MotionAC2 2-Axis Accelerometer Calibration Library
...
- The MotionAC2 provides real-time 2-axis accelerometer calibration.
...
- [Getting started with MotionAC2 2-axis accelerometer calibration library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00733317-getting-started-with-motionac2-2axis-accelerometer-calibration-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section12" aria-hidden="true">V1.3.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section11" aria-hidden="true">V1.3.0 / 21-April-2021</label>
<div>			
...
<label for="collapse-section10" aria-hidden="true">V1.2.0 / 26-February-2021</label>
<div>			
...
- Updated STM32 device check
- Added BlueNRG-LP device check
...
<label for="collapse-section9" aria-hidden="true">V1.1.0 / 20-July-2020</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionAC2** ,
