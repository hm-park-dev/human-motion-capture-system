---
pagetitle: Release Notes for MotionPW Library
lang: en
...
<center>
# Release Notes for MotionPW Pedometer for Wrist Library
...
- The MotionPW provides real-time information about the number of steps, cadence and confidence which the user just performed with the wearable device, e.g. smart watch.
- The library acquires data from the accelerometer and provides information about the number of steps, cadence and confidence which the user just performed with the device.
...
- [Getting started with MotionPW real-time pedometer for wrist library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00472437-getting-started-with-motionpw-realtime-pedometer-for-wrist-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section10" aria-hidden="true">V1.4.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section9" aria-hidden="true">V1.4.0 / 12-May-2021</label>
<div>			
...
<label for="collapse-section8" aria-hidden="true">V1.3.0 / 01-March-2021</label>
<div>			
...
<label for="collapse-section7" aria-hidden="true">V1.2.0 / 13-November-2020</label>
<div>			
...
<label for="collapse-section6" aria-hidden="true">V1.1.1 / 15-February-2019</label>
<div>			
...
<label for="collapse-section5" aria-hidden="true">V1.1.0 / 28-September-2018</label>
<div>			
...
- Improve step detection initialization and reset
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionPW** ,
