---
pagetitle: Release Notes for MotionFD Library
lang: en
...
<center>
# Release Notes for MotionFD Fall Detection Library
...
- The MotionSD provides real-time information about the user fall event based on data from a device. It is able to distinguish whether the user fall occurred or not.
- The library acquires data from the accelerometer and pressure sensor and provides information about user fall event.
...
- [Getting started with MotionFD real-time fall detection library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00427990-getting-started-with-motionfd-realtime-fall-detection-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section4" aria-hidden="true">V1.2.1 / 24-August-2021</label>
<div>			
...
<label for="collapse-section4" aria-hidden="true">V1.2.0 / 05-May-2021</label>
<div>			
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on **MotionFD** ,
