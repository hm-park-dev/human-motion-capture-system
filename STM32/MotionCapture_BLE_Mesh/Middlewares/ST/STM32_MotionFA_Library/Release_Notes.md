---
pagetitle: Release Notes for MotionFA Library
lang: en
...
<center>
# Release Notes for MotionFA Fitness Activities Library
...
- The MotionFA provides real-time information about number of repetition of various fitness activities performed by a user.
- The library acquires data from the accelerometer, gyroscope and pressure sensor and provides information about number of repetition of various fitness activities performed by a user. It is able to count number of bicep curls, squats and push-ups.
...
- [Getting started with MotionFA fitness activity library in X-CUBE-MEMS1 expansion for STM32Cube](https://www.st.com/resource/en/user_manual/dm00391121-getting-started-with-motionfa-fitness-activity-library-in-xcubemems1-expansion-for-stm32cube-stmicroelectronics.pdf)
...
<label for="collapse-section8" aria-hidden="true">V1.3.0 / 05-May-2021</label>
<div>			
...
<label for="collapse-section4" aria-hidden="true">V1.0.1 / 1-September-2017</label>
<div>			
